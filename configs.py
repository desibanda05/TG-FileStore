...
class Config(object):
	...
	BOT_TOKEN = os.environ.get("BOT_TOKEN", "5662359656:AAEN3srgkyZ5fpLsU_kZJ6M4weXtpX4qIHY")
	BOT_USERNAME = os.environ.get("BOT_USERNAME", "File_Store_Pro_Robot")
	DB_CHANNEL = int(os.environ.get("DB_CHANNEL", "-1001845763241"))
	BOT_OWNER = int(os.environ.get("BOT_OWNER", "1459910748"))
	...
	UPDATES_CHANNEL = os.environ.get("UPDATES_CHANNEL", "-1001162256971")
	LOG_CHANNEL = os.environ.get("LOG_CHANNEL", "-1001712123362")
...
│
├🔹👥 **Bot Support:** [𝐒𝐮𝐩𝐩𝐨𝐫𝐭](https://t.me/+cTsBLwDFiE44NzY1)
│
├🔸🔔 **Bot Updates:** [𝐔𝐩𝐝𝐚𝐭𝐞𝐬](https://t.me/My_Test_Botz)
│
╰──────[ 😎 ]───────────⍟
"""
	ABOUT_DEV_TEXT = f"""
🧑🏻‍💻 **𝗗𝗲𝘃𝗲𝗹𝗼𝗽𝗲𝗿:** [@MR_JAGANMOHAN](https://t.me/MR_JAGANMOHAN) 
...
[**Donate Me**](https://t.me/MR_JAGANMOHAN) (Contact Me)
"""
	HOME_TEXT = """
Hello, [{}](tg://user?id={})\n\nThis is a Permanent **FileStore Bot**.
